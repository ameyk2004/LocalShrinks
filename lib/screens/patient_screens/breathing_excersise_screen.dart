...
import 'package:local_shrinks/utils/colors.dart'; // Add this import statement
          ...
          children: [
            ...
            InkWell(
              ...
              child: Container(
                ...
                child: Center(child: Text("Start Excersise", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 20),)),
              ),
            )
          ],
        ),
