          ...
          children: [
            Expanded(
              child: Column(
                children: [
                  CircleAvatar(
                    backgroundImage: NetworkImage("https://img.freepik.com/free-vector/skull-gaming-with-joy-stick-emblem-modern-style_32991-492.jpg?size=626&ext=jpg"),
...
class _BubbleWidgetState extends State<BubbleWidget> {
  ...
  Future<void> playSound() async {
    try {
      await player.play(
        AssetSource("assets/images/bubble-sound-43207.mp3)",)
      );
    } catch (e) {
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          image: DecorationImage(
              image: popped ? AssetImage("assets/images/pop-the-bubble-md.png") : AssetImage("assets/images/bubble.png")
              // image:
          )
        ),
      ),
